...
<div class="main">
    ...
    <div class="card">
        <form method="POST" action="/vendor/products/{{ $product->id }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="grid-2">
            ...
            <div class="form-group">
                ...
                @if($product->image)
                <img src="{{ asset('storage/'.$product->image) }}" style="width:120px;height:120px;object-fit:cover;border-radius:8px;margin-bottom:10px">
                @else
                <p style="color:#64748b;font-size:13px;margin-bottom:10px">Aucune image</p>
                @endif
